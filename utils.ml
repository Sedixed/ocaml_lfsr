...
(* à coefficient dans F2. Nous utiliserons la représentation creuse, et les *)
(* valeurs contenues dans la liste représentent les degrés où sont présent le coefficient 1. *)
...
(* Renvoie true ssi le coefficient au degré i n'est pas 0 *)
...
let poly_to_binary base =
	...
	in aux [] 0 (List.hd (List.rev base) + 1) base;;
